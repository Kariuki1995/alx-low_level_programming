 ...
 * and provide machine-independent data.The initial bytes of an ELF header (and an object file) correspond to the e_ident member.
/**
 * check_if_elf - checks if file is an ELF file by checking if it
 * contains the magic numbers/file signature of an ELF file
 * @e_ident: a pointer to an array of bytes specifies how to interpret the file
 * Return: nothing
 */
 ...
 * @e_entry: the virtual memory address from where the process starts executing
 * @e_ident: a pointer to an array of bytes specifies how to interpret the file
 * Return: nothing
 */
